...
* [PlayCanvas Engine](https://github.com/playcanvas/engine) ⭐ 16,539 | 🐛 530 | 🌐 JavaScript | 📅 2026-08-22 - Open source JavaScript graphics application framework.
...
* [PlayCanvas Web Components](https://github.com/playcanvas/web-components) ⭐ 107 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-22 - Open source Web Components wrapper for the PlayCanvas Engine.
...
* [@recast-navigation/playcanvas](https://www.npmjs.com/package/@recast-navigation/playcanvas) - NavMesh and Pathfinding using [Recast](https://github.com/recastnavigation/recastnavigation) ⭐ 7,868 | 🐛 133 | 🌐 C++ | 📅 2026-02-27 for PlayCanvas.
...
* [Quake](https://github.com/willeastcott/playcanvas-quake) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-20 - A port of id Software's Quake to PlayCanvas.
...
Please see [CONTRIBUTING](https://github.com/playcanvas/awesome-playcanvas/blob/master/CONTRIBUTING.md) ⭐ 478 | 🐛 0 | 📅 2026-08-22 for details.
