...
* [PlayCanvas Engine](https://github.com/playcanvas/engine) ⭐ 16,664 | 🐛 512 | 🌐 JavaScript | 📅 2026-09-07 - Open source JavaScript graphics application framework.
...
* [PlayCanvas React](https://github.com/playcanvas/react) ⭐ 524 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-07 - Open source React wrapper for the PlayCanvas Engine.
* [PlayCanvas Web Components](https://github.com/playcanvas/web-components) ⭐ 109 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-07 - Open source Web Components wrapper for the PlayCanvas Engine.
...
* [tween.js](https://github.com/tweenjs/tween.js/) ⭐ 10,139 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-01 - Popular JavaScript tweening library that integrates easily with PlayCanvas.
* [@recast-navigation/playcanvas](https://www.npmjs.com/package/@recast-navigation/playcanvas) - NavMesh and Pathfinding using [Recast](https://github.com/recastnavigation/recastnavigation) ⭐ 7,901 | 🐛 144 | 🌐 C++ | 📅 2026-02-27 for PlayCanvas.
...
* [playcanvas-opti-pixel](https://github.com/AlexAPPi/playcanvas-opti-pixel) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-06 - GPU instancing, LOD, BVH frustum culling, and occlusion culling.
...
Please see [CONTRIBUTING](https://github.com/playcanvas/awesome-playcanvas/blob/master/CONTRIBUTING.md) ⭐ 485 | 🐛 1 | 📅 2026-09-06 for details.
