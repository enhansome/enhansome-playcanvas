...
* [PlayCanvas Engine](https://github.com/playcanvas/engine) ⭐ 16,902 | 🐛 454 | 🌐 JavaScript | 📅 2026-09-24 - Open source JavaScript graphics application framework.
...
* [PlayCanvas React](https://github.com/playcanvas/react) ⭐ 533 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-11 - Open source React wrapper for the PlayCanvas Engine.
* [PlayCanvas Web Components](https://github.com/playcanvas/web-components) ⭐ 110 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-23 - Open source Web Components wrapper for the PlayCanvas Engine.
...
* [@recast-navigation/playcanvas](https://www.npmjs.com/package/@recast-navigation/playcanvas) - NavMesh and Pathfinding using [Recast](https://github.com/recastnavigation/recastnavigation) ⭐ 7,935 | 🐛 148 | 🌐 C++ | 📅 2026-02-27 for PlayCanvas.
