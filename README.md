...
* [PlayCanvas Engine](https://github.com/playcanvas/engine) ⭐ 16,649 | 🐛 513 | 🌐 JavaScript | 📅 2026-09-06 - Open source JavaScript graphics application framework.
...
* [@recast-navigation/playcanvas](https://www.npmjs.com/package/@recast-navigation/playcanvas) - NavMesh and Pathfinding using [Recast](https://github.com/recastnavigation/recastnavigation) ⭐ 7,896 | 🐛 144 | 🌐 C++ | 📅 2026-02-27 for PlayCanvas.
...
* [Quake](https://github.com/willeastcott/playcanvas-quake) ⭐ 10 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-20 - A port of id Software's Quake to PlayCanvas.
