...
* [PlayCanvas Engine](https://github.com/playcanvas/engine) ⭐ 16,675 | 🐛 514 | 🌐 JavaScript | 📅 2026-09-08 - Open source JavaScript graphics application framework.
...
* [PlayCanvas Web Components](https://github.com/playcanvas/web-components) ⭐ 109 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-08 - Open source Web Components wrapper for the PlayCanvas Engine.
...
* [@recast-navigation/playcanvas](https://www.npmjs.com/package/@recast-navigation/playcanvas) - NavMesh and Pathfinding using [Recast](https://github.com/recastnavigation/recastnavigation) ⭐ 7,902 | 🐛 144 | 🌐 C++ | 📅 2026-02-27 for PlayCanvas.
...
* [playcanvas-opti-pixel](https://github.com/AlexAPPi/playcanvas-opti-pixel) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-08 - GPU instancing, LOD, BVH frustum culling, and occlusion culling.
...
Please see [CONTRIBUTING](https://github.com/playcanvas/awesome-playcanvas/blob/master/CONTRIBUTING.md) ⭐ 485 | 🐛 2 | 📅 2026-09-06 for details.
