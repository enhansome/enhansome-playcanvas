...
* [PlayCanvas Engine](https://github.com/playcanvas/engine) ⭐ 16,850 | 🐛 470 | 🌐 JavaScript | 📅 2026-09-21 - Open source JavaScript graphics application framework.
...
* [tween.js](https://github.com/tweenjs/tween.js/) ⭐ 10,147 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-22 - Popular JavaScript tweening library that integrates easily with PlayCanvas.
* [@recast-navigation/playcanvas](https://www.npmjs.com/package/@recast-navigation/playcanvas) - NavMesh and Pathfinding using [Recast](https://github.com/recastnavigation/recastnavigation) ⭐ 7,930 | 🐛 144 | 🌐 C++ | 📅 2026-02-27 for PlayCanvas.
...
* [playcanvas-opti-pixel](https://github.com/AlexAPPi/playcanvas-opti-pixel) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-21 - GPU instancing, LOD, BVH frustum culling, and occlusion culling.
